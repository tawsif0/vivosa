...
export default function MensPants() {
  const items = useMemo(() => mensPants, []);

  const formatTitle = (title) => (
    <span className="text-sm font-sans tracking-tight text-black leading-snug">
      <strong className="font-bold mr-1 text-[13px] tracking-normal uppercase">MEN</strong> {title}
    </span>
  );
      ...
      <section className="max-w-container-max mx-auto px-4 md:px-margin-desktop py-12 md:py-16">
        <div className="flex flex-col gap-4 max-w-3xl">
          ...
          <p className="font-body-lg text-on-surface-variant leading-relaxed">
            Explore our premium men’s pants, crafted with meticulous attention to detail and sustainable fabrics.
          </p>
        </div>
      </section>
