...
const LeatherLiningCreate = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const loadingToast = toast.loading("Creating lining leather item...");
    ...
    try {
      ...
      toast.success("Lining leather item created");
      setForm(emptyForm);
      setImageFile(null);
    } catch (error) {
      toast.dismiss(loadingToast);
      ...
      >
        ...
        <div className="space-y-6">
          <ImageUploadBox
            ...
            description="Click to upload high-quality lining leather image"
            preview={preview}
            fileName={imageFile?.name}
            inputId="lining-image-upload"
          ...
          >
            ...
            {isSubmitting ? "Creating..." : "Create Lining Leather Item"}
          </button>
        </div>
      </motion.form>
    </div>
...
export default LeatherLiningCreate;
