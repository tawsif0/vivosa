  ...
  return (
    <div className="bg-white text-primary font-body min-h-screen selection:bg-accent-gold/30">
      <main className="pt-20 md:pt-[88px]">
            ...
            <div className="py-16 px-6 sm:px-12 lg:px-20 xl:px-24 flex flex-col justify-center space-y-10 bg-white">
              ...
              <div className="pt-6 border-t border-neutral-100">
                <Link
                  ...
                  to="/automotive"
                >
                  <span className="inline-flex items-center gap-1.5"><span className="material-symbols-outlined text-[16px]">arrow_back</span> Back to Automotive Collection</span>
                </Link>
              </div>
        ...
        <DetailsExtraSections privacyId="privacy-automotive-detail" />
      </main>
    </div>
  );
}
