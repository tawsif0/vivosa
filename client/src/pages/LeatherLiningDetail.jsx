      ...
      <main className="pt-20 md:pt-[88px]">
        ...
        <section className="bg-white border-b border-neutral-100">
          <div className="grid grid-cols-1 lg:grid-cols-2 items-start gap-0">
            ...
            {/* Left Column: Boxed, fully-visible image */}
            ...
            <div className="py-16 px-6 sm:px-12 lg:px-20 xl:px-24 flex flex-col justify-center space-y-10 bg-white">
              ...
              <div className="pt-6 border-t border-neutral-100">
                <Link
                  ...
                  to="/leather-lining"
                >
                  <span className="inline-flex items-center gap-1.5"><span className="material-symbols-outlined text-[16px]">arrow_back</span> Back to Lining Collection</span>
                </Link>
              </div>
            </div>
          </div>
