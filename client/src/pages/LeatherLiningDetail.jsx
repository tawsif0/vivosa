        ...
        <section className="bg-neutral-50 py-16 px-6 md:px-24 border-t border-neutral-200/60">
          <div className="max-w-xl mx-auto text-center space-y-6">
            ...
            <div className="flex items-center justify-center gap-2 text-[10px] text-neutral-500 max-w-sm mx-auto leading-relaxed">
              <input
                type="checkbox"
                id="privacy-policy-lining"
                className="mt-0.5 border-neutral-300 rounded-sm cursor-pointer accent-[#222]"
                required
              />
              <label htmlFor="privacy-policy-lining" className="cursor-pointer select-none">
                I declare that I have read and accepted the privacy policy.{" "}
                <a href="/privacy" className="underline hover:text-neutral-800">(read the policy)</a>
              </label>
            </div>
          </div>
        </section>
