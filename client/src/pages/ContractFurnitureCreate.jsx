...
const ContractFurnitureCreate = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const loadingToast = toast.loading("Creating furniture leather item...");
    ...
    try {
      ...
      toast.success("Furniture leather item created");
      setForm(emptyForm);
      setImageFile(null);
    } catch (error) {
      toast.dismiss(loadingToast);
      ...
      >
        ...
        <div className="space-y-6">
          <ImageUploadBox
            ...
            description="Click to upload high resolution sample texture image"
            preview={preview}
            fileName={imageFile?.name}
            inputId="furniture-image-upload"
          ...
          >
            ...
            {isSubmitting ? "Creating..." : "Create Furniture Leather Item"}
          </button>
        </div>
      </motion.form>
    </div>
...
export default ContractFurnitureCreate;
