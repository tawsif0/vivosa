    ...
    <div className="space-y-6">
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-1 text-sm text-slate-600">
          Add an admin-controlled leather article for premium leather goods.
        </p>
      </div>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <label className="block">
              ...
              <input
                ...
                placeholder="e.g. F016CMNO, Cream"
            ...
            <label className="block">
              ...
              <input
                ...
                value={form.fullName}
                onChange={handleChange}
                placeholder="e.g. F016CMNO, Cream---Semi-Aniline / Full Grain"
                className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 outline-none"
              />
            </label>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <label className="block">
              ...
              <input
                ...
                value={form.subtitle}
                onChange={handleChange}
                placeholder="LEATHER SUITABLE FOR PREMIUM LEATHER GOODS PRODUCTION"
                className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 outline-none"
              />
            </label>
