...
const WomenCreate = ({ category }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      await createWomenApparel(payload);
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <h2 className="mt-2 text-2xl font-bold text-slate-900">Create Women &apos;s {categoryLabel} Item</h2>
        <p className="mt-1 text-sm text-slate-600">
          Add an admin controlled women apparel item with custom color variants, labels, and image uploads.
        </p>
      </div>
        ...
        <div className="space-y-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="border-t border-slate-100 pt-6">
            ...
            <div className="rounded-2xl bg-slate-50/50 border border-slate-100 p-4 space-y-4">
              ...
              {/* Dynamic Label Editor (dependent on tab, shown after the tab) */}
                  ...
                  {variantImagePreview ? (
                    ...
                    <div>
                      <input
                        ...
                        className="hidden"
                        id="variant-image-uploader"
                      />
                      <label
                        htmlFor="variant-image-uploader"
