...
export default function MensSweaterDetails() {
  ...
  if (!item) {
    return (
      <div className="pt-32 px-4 md:px-margin-desktop max-w-container-max mx-auto min-h-screen">
        ...
        <Link className="text-leather-tan underline mt-4 inline-block font-sans" to="/mens/sweaters">
          <span className="inline-flex items-center gap-1.5"><span className="material-symbols-outlined text-[16px]">arrow_back</span> Back to Men&apos;s Sweaters</span>
        </Link>
      </div>
    );
  }
  ...
  return (
    <div className="bg-background text-on-background font-body-md text-body-md antialiased overflow-x-hidden pt-20">
      ...
      <DetailsExtraSections privacyId="privacy-mens-sweaters" />
    </div>
  );
}
